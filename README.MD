...
Para esta prueba tecnica se dara la configuracion del env.local este esta conectado a mongodb Atlas el cual es un servicio de alamacenamiento en la nube
